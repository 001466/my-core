...
//				sb.append("\n authorization:").append(request.getHeader(TokenConstant.AUTHORIZATION));
//				sb.append("\n params:").append(JsonUtil.toJson(request.getParameterMap()));
//				sb.append("\n body:").append(stringBuffer.toString());
